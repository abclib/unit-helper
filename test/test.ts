...
test(`('9876543210.9876543210').format()              => '9,876,543,210.987654321'`, () => {
  const res = UnitHelper('9876543210.9876543210', 'invalid').format()
  expect(res).toBe('9,876,543,210.987654321')
})

test(`('9876543210.9876543210', 'invalid').format()   => '9,876,543,210.987654321'`, () => {
  const res = UnitHelper('9876543210.9876543210', 'invalid').format()
  expect(res).toBe('9,876,543,210.987654321')
})

test(`('9876543210.9876543210', 'btc_gwei').format()  => '9,876,543,210.987654321'`, () => {
  const res = UnitHelper('9876543210.9876543210', 'btc').format()
  expect(res).toBe('9,876,543,210.987654321')
})

test(`('987654321098765432109', 'wei_gwei').format(7) => '987,654,321,098.7654321'`, () => {
  const res = UnitHelper('987654321098765432109', 'wei_gwei').format(7)
  expect(res).toBe('987,654,321,098.7654321')
})

test(`('9,876,543,210,987,654', 'wei_gwei').format(7) => '9,876,543.2109876'`, () => {
  const res = UnitHelper('9,876,543,210,987,654', 'wei_gwei').format(7)
  expect(res).toBe('9,876,543.2109876')
})

test(`('987654321012345000000', 'wei_gwei').format(7) => '987,654,321,012.345'`, () => {
  const res = UnitHelper('987654321012345000000', 'wei_gwei').format(7)
  expect(res).toBe('987,654,321,012.345')
})

test(`('987654321012345000000', 'wei_gwei').toFormat(7) => '987,654,321,012.3450000'`, () => {
